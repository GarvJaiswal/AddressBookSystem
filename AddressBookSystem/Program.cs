    ...
    class Program
    {
        static void Main()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("7. Search all names in a City or State");
                Console.WriteLine("8. Enter name of the city to get count of");
                Console.WriteLine("9. Enter name of the state to get count of");
